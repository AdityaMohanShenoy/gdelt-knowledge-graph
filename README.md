...
The JSONL report is written under `data/evidence/articles/benchmarks/` and contains the previous database result beside Trafilatura precision and recall candidates. Review this report before promoting a new extraction pass. Promotion is resumable and only reads existing compressed raw HTML:
